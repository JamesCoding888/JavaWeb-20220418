...
public class JPAQueryPersonServlet extends JPAService {
	...
	private void doHandle(HttpServletRequest req, HttpServletResponse resp) 
		...
		out.print(jpaService.getPersonById(2) + "<p />");
		out.print(jpaService.queryAllPerson() + "<p />");
		out.print(jpaService.queryPersonByAge(20) + "<p />");
		
		out.print(jpaService.findAll() + "<p />");
		out.print(jpaService.findByName("ab%") + "<p />");
		out.print(jpaService.findByName("%tz") + "<p />");
		out.print(jpaService.findByName("%co%") + "<p />");
